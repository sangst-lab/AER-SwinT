...
class Loss_main_task(nn.BCELoss, base.Loss):
    pass

class Loss_main_sub1_sub2_task(base.Loss):
    def __init__(self, weight=None):
        super().__init__()
        self.loss_main = nn.BCELoss()
        self.loss_sub1 = nn.BCELoss()
        self.loss_sub2 = nn.BCELoss()

    def forward(self, prediction_main, prediction_sub1, prediction_sub2, target_main, target_sub1, target_sub2):
        loss_main = self.loss_main(prediction_main, target_main)
